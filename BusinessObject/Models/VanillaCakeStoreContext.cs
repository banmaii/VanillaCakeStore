...
{
    public partial class VanillaCakeStoreContext : DbContext
    {
        public VanillaCakeStoreContext()
        {
        }

        public VanillaCakeStoreContext(DbContextOptions<VanillaCakeStoreContext> options)
            : base(options)
        {
        }
